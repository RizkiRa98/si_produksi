...
if (isset($_POST['simpan'])) {
    ...
    if (!$query) {
        echo "<script> alert('Data Tidak Boleh Kosong'); location.href = \"../admin/produksi_edit.php?produksi\"; </script>";
    } else {
        echo "<script> alert('Data Berhasil Ubah'); location.href = \"../admin/produksi.php?produksi\"; </script>";
    }
} else {
    return;
}
