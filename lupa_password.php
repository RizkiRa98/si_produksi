                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="reset_password.php" method="POST">
                                        ...
                                        <button type="submit" name="lupa-password" class="btn btn-primary btn-user btn-block">
                                            Reset Password
                                        </button>
                                        <a href="login.php" name="kembali" class="btn btn-secondary btn-user btn-block">
                                            Kembali
                                        </a>
                                        <hr>
