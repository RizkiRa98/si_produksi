                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Detail Perencanaan</h1>
                        </div>

                        <!-- Tabel Produksi -->
                        <table class="table table-striped table-hover table-bordered w-100">
                            <tr>
                                <td class="w-25">ID Perencanaan</td>
                                <td class="text-left"><?php echo $data['id_perencanaan'] ?></td>
                            </tr>
                            ...
                            <tr>
                                <td class="w-25">Nama Ketua Grup</td>
                            ...
                            <tr>
                                <td class="w-25">Tanggal Order</td>
                                <td class="text-left"><?php echo $data['tgl_order'] ?></td>
                            </tr>
                        </table>
