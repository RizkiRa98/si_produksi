...
?>
    ...
    <head>
        ...
        <title>Detail Penjadwalan</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Detail Penjadwalan</h1>
                        </div>

                        <!-- Tabel Produksi -->
                        <table class="table table-striped table-hover table-bordered w-100">
                            <tr>
                                <td class="w-50">ID Penjadwalan</td>
                                <td class="text-left"><?php echo $data['id_penjadwalan'] ?></td>
                            </tr>
                            ...
                            <tr>
                                <td class="w-50">Tanggal Mulai</td>
                                <td class="text-left"><?php echo $data['tgl_mulai'] ?></td>
                            </tr>

                            <tr>
                                <td class="w-50">Tanggal Akhir</td>
