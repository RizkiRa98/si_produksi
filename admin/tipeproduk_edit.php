...
$query = mysqli_query($conf, "SELECT * FROM produk WHERE id_produk='$id_produk'");
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Form Tambah -->
                        <form action="../fungsi/ubahTipeproduk.php" enctype="multipart/form-data" method="POST">

                            <div class="form-group" hidden>
                                <label>ID Produk</label>
                                <input type="text" name="id_produk" id="id_produk" class="form-control" value="<?php echo $data['id_produk'] ?>" readonly hidden>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_bahan" class="form-control">
                                    ...
                                    while ($data1 = mysqli_fetch_array($query)) {
                                    ?>
                                        <option value="<?= $data1['id_bahan']; ?>" <?php if ($data['id_bahan'] == $data1['id_bahan'])
                                                                                        echo 'selected="selected"';
                                                                                    ?>>
                                            <?= $data1['nama_bahan'];
                                            ?>
