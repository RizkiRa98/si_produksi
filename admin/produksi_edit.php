            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Form Tambah -->
                        <form action="../fungsi/ubahProduksi.php" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_konsumen" id="nama_konsumen" class="form-control" placeholder="Masukkan Nama Konsumen" value="<?php echo $data['nama_konsumen'] ?>">
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    ...
                                    <input type="date" name="tgl_mulai" class="form-control" value="<?php echo $data['tgl_mulai'] ?>">
                                </div>

                                <div class="form-group col">
                                    <label for="tgl_akhir">Tanggal Akhir Produksi</label>
                                    <input type="date" name="tgl_akhir" class="form-control" value="<?php echo $data['tgl_akhir'] ?>">
                                </div>
                            </div>
